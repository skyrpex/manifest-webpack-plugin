...
var ManifestWebpackPlugin = function () {
  function ManifestWebpackPlugin() {
    var filename = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'manifest.json';
  ...
  _createClass(ManifestWebpackPlugin, [{
    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('done', function (stats) {
        ...
        _fs2.default.writeFileSync(_path2.default.resolve(compiler.options.output.path, _this.filename), JSON.stringify(files));
      });
    }
  }]);
